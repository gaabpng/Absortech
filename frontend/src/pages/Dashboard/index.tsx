...
import homeStyles from "src/pages/Homepage/styles.module.css";
import instagram from "src/assets/InstagramLogo.png";
import youtube from "src/assets/youtubeLogo.png";
import linkedin from "src/assets/linkedlnLogo.png";
import facebook from "src/assets/facebookLogo.png";
import poweredByLogo from "src/assets/PoweredBy.png";
    ...
    <div className={homeStyles.container}>
      ...
      <footer className={homeStyles.footer}>
        ...
        <div className={homeStyles.footerCenter}>
          ...
          <a
            href="https://edu.ieee.org/br-uff/"
            target="_blank"
            rel="noopener noreferrer"
            title="Powered by UFF"
          >
            <img
              src={poweredByLogo}
              alt="Powered by Logo"
              className={homeStyles.poweredByLogo}
            />
          </a>
          <p className={homeStyles.footerText}>
            © 2024 CS EPS & WIE. Todos os direitos reservados.
          </p>
        </div>
        ...
        <div className={homeStyles.footerRight}>
          <div className={homeStyles.socialIcons}>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              title="Instagram IEEE UFF"
            >
              <img src={instagram} alt="Instagram Logo" />
            </a>
            <a
              href="https://www.youtube.com/user/ieeeuffsb"
              target="_blank"
              rel="noopener noreferrer"
              title="YouTube IEEE UFF"
            >
              <img src={youtube} alt="YouTube Logo" />
            </a>
            <a
              href="https://br.linkedin.com/company/ramo-estudantil-ieee-uff"
              target="_blank"
              rel="noopener noreferrer"
              title="LinkedIn IEEE UFF"
            >
